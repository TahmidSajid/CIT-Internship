...
$data_check = "SELECT COUNT(*) AS result FROM `users` WHERE email='$email' AND password='$password'";
...
if ($result == 1) {
    $data_get = "SELECT * FROM `users` WHERE email='$email' AND password='$password'";
