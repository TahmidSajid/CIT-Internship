                ...
                <div class="card-body" style="padding-top: 30px; padding-bottom:100px">
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-10 offset-lg-1">
                            <form class="" action="{{ route('name_change') }}" method="POST">
                                @csrf
                    ...
                    <div class="row mb-4">
                        @if ($otp_check == null)
                            <div class="col-lg-10 offset-lg-1">
                                <form class="" action="{{ route('email_change') }}" method="POST">
                                    @csrf
                                    <div class="row mx-auto">
                        ...
                        @else
                        <div class="col-lg-10 offset-lg-1">
                            <form class="" action="{{ route('otp_verify') }}" method="POST">
                                @csrf
                                <div class="row mx-auto">
                                    <label class="col-md-3 col-form-label">OTP</label>
                                    <div class="col-md-9">
                                        <input type="email" class="d-none" name="new_email" value="{{ $new_email }}">
                                        <div class="input-group">
