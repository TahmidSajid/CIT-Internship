                ...
                <div class="post featured-post-lg">
                    ...
                    <a href="blog-single.html">
                        <div class="thumb rounded">
                            <div class="inner data-bg-image" data-bg-image="{{ asset('frontend-assets') }}/images/posts/featured-lg.jpg"></div>
                        </div>
                    </a>
                </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="post">
                                <div class="thumb rounded">
                                    ...
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('frontend-assets') }}/images/posts/editor-lg.jpg" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <ul class="meta list-inline mt-4 mb-0">
                                    <li class="list-inline-item"><a href="#"><img src="{{ asset('frontend-assets') }}/images/other/author-sm.png" class="author" alt="author"/>Katen Doe</a></li>
                                    <li class="list-inline-item">29 March 2021</li>
                                </ul>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="post post-list-sm square">
                                <div class="thumb rounded">
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('frontend-assets') }}/images/posts/editor-sm-1.jpg" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <div class="details clearfix">
                            ...
                            <div class="post post-list-sm square">
                                <div class="thumb rounded">
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('frontend-assets') }}/images/posts/editor-sm-2.jpg" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <div class="details clearfix">
                            ...
                            <div class="post post-list-sm square">
                                <div class="thumb rounded">
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('frontend-assets') }}/images/posts/editor-sm-3.jpg" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <div class="details clearfix">
                            ...
                            <div class="post post-list-sm square">
                                <div class="thumb rounded">
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('frontend-assets') }}/images/posts/editor-sm-4.jpg" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <div class="details clearfix">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="post">
                                <div class="thumb rounded">
                                    ...
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('frontend-assets') }}/images/posts/trending-lg-1.jpg" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <ul class="meta list-inline mt-4 mb-0">
                            ...
                            <div class="post post-list-sm square before-seperator">
                                <div class="thumb rounded">
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('frontend-assets') }}/images/posts/trending-sm-1.jpg" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <div class="details clearfix">
                            ...
                            <div class="post post-list-sm square before-seperator">
                                <div class="thumb rounded">
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('frontend-assets') }}/images/posts/trending-sm-2.jpg" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <div class="details clearfix">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="post">
                                <div class="thumb rounded">
                                    ...
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('frontend-assets') }}/images/posts/trending-lg-2.jpg" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <ul class="meta list-inline mt-4 mb-0">
                            ...
                            <div class="post post-list-sm square before-seperator">
                                <div class="thumb rounded">
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('frontend-assets') }}/images/posts/trending-sm-3.jpg" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <div class="details clearfix">
                            ...
                            <div class="post post-list-sm square before-seperator">
                                <div class="thumb rounded">
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('frontend-assets') }}/images/posts/trending-sm-4.jpg" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <div class="details clearfix">
                ...
                <div class="row post-carousel-twoCol post-carousel">
                    ...
                    <div class="post post-over-content col-md-6">
                        ...
                        <a href="blog-single.html">
                            <div class="thumb rounded">
                                <div class="inner">
                                    <img src="{{ asset('frontend-assets') }}/images/posts/inspiration-1.jpg" alt="thumb" />
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="post post-over-content col-md-6">
                        ...
                        <a href="blog-single.html">
                            <div class="thumb rounded">
                                <div class="inner">
                                    <img src="{{ asset('frontend-assets') }}/images/posts/inspiration-2.jpg" alt="thumb" />
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <div class="col-md-12 col-sm-6">
                            ...
                            <div class="post post-list clearfix">
                                <div class="thumb rounded">
                                    ...
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('frontend-assets') }}/images/posts/latest-sm-1.jpg" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <div class="details">
                        ...
                        <div class="col-md-12 col-sm-6">
                            ...
                            <div class="post post-list clearfix">
                                <div class="thumb rounded">
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('frontend-assets') }}/images/posts/latest-sm-2.jpg" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <div class="details">
                        ...
                        <div class="col-md-12 col-sm-6">
                            ...
                            <div class="post post-list clearfix">
                                <div class="thumb rounded">
                                    ...
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('frontend-assets') }}/images/posts/latest-sm-3.jpg" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <div class="details">
                        ...
                        <div class="col-md-12 col-sm-6">
                            ...
                            <div class="post post-list clearfix">
                                <div class="thumb rounded">
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('frontend-assets') }}/images/posts/latest-sm-4.jpg" alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                                <div class="details">
                            ...
                            <div class="post-carousel-widget">
                                ...
                                <div class="post post-carousel">
                                    <div class="thumb rounded">
                                        ...
                                        <a href="blog-single.html">
                                            <div class="inner">
                                                <img src="{{ asset('frontend-assets') }}/images/widgets/widget-carousel-1.jpg" alt="post-title" />
                                            </div>
                                        </a>
                                    </div>
                                ...
                                <div class="post post-carousel">
                                    <div class="thumb rounded">
                                        ...
                                        <a href="blog-single.html">
                                            <div class="inner">
                                                <img src="{{ asset('frontend-assets') }}/images/widgets/widget-carousel-2.jpg" alt="post-title" />
                                            </div>
                                        </a>
                                    </div>
